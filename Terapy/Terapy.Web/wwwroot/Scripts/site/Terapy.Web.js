...
(function (Terapy) {
    var TerapyDB;
    (function (TerapyDB) {
        var UnableTerapyCustomerDialog = /** @class */ (function (_super) {
...
(function (Terapy) {
    var TerapyDB;
    (function (TerapyDB) {
        var UnableTerapyCustomerGrid = /** @class */ (function (_super) {
...
(function (Terapy) {
    var TerapyDB;
    (function (TerapyDB) {
        var TurnTerapyDialog = /** @class */ (function (_super) {
            __extends(TurnTerapyDialog, _super);
            function TurnTerapyDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new TerapyDB.TurnTerapyForm(_this.idPrefix);
                return _this;
            }
            TurnTerapyDialog.prototype.getFormKey = function () { return TerapyDB.TurnTerapyForm.formKey; };
            TurnTerapyDialog.prototype.getIdProperty = function () { return TerapyDB.TurnTerapyRow.idProperty; };
            TurnTerapyDialog.prototype.getLocalTextPrefix = function () { return TerapyDB.TurnTerapyRow.localTextPrefix; };
            TurnTerapyDialog.prototype.getNameProperty = function () { return TerapyDB.TurnTerapyRow.nameProperty; };
            TurnTerapyDialog.prototype.getService = function () { return TerapyDB.TurnTerapyService.baseUrl; };
            TurnTerapyDialog = __decorate([
                Serenity.Decorators.registerClass(),
                Serenity.Decorators.responsive()
            ], TurnTerapyDialog);
            return TurnTerapyDialog;
        }(Serenity.EntityDialog));
        TerapyDB.TurnTerapyDialog = TurnTerapyDialog;
    })(TerapyDB = Terapy.TerapyDB || (Terapy.TerapyDB = {}));
})(Terapy || (Terapy = {}));
var Terapy;
(function (Terapy) {
    var TerapyDB;
    (function (TerapyDB) {
        var TurnTerapyGrid = /** @class */ (function (_super) {
            __extends(TurnTerapyGrid, _super);
            function TurnTerapyGrid(container) {
                return _super.call(this, container) || this;
            }
            TurnTerapyGrid.prototype.getColumnsKey = function () { return 'TerapyDB.TurnTerapy'; };
            TurnTerapyGrid.prototype.getDialogType = function () { return TerapyDB.TurnTerapyDialog; };
            TurnTerapyGrid.prototype.getIdProperty = function () { return TerapyDB.TurnTerapyRow.idProperty; };
            TurnTerapyGrid.prototype.getLocalTextPrefix = function () { return TerapyDB.TurnTerapyRow.localTextPrefix; };
            TurnTerapyGrid.prototype.getService = function () { return TerapyDB.TurnTerapyService.baseUrl; };
            TurnTerapyGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], TurnTerapyGrid);
...
(function (Terapy) {
    var TerapyDB;
    (function (TerapyDB) {
        var TerapyTypeDialog = /** @class */ (function (_super) {
...
(function (Terapy) {
    var TerapyDB;
    (function (TerapyDB) {
        var TerapyTypeGrid = /** @class */ (function (_super) {
...
(function (Terapy) {
    var TerapyDB;
    (function (TerapyDB) {
        var SchedulerTerapyDialog = /** @class */ (function (_super) {
...
(function (Terapy) {
    var TerapyDB;
    (function (TerapyDB) {
        var SchedulerTerapyGrid = /** @class */ (function (_super) {
...
(function (Terapy) {
    var TerapyDB;
    (function (TerapyDB) {
        var MessagesTranslationDialog = /** @class */ (function (_super) {
...
(function (Terapy) {
    var TerapyDB;
    (function (TerapyDB) {
        var MessagesTranslationGrid = /** @class */ (function (_super) {
...
(function (Terapy) {
    var TerapyDB;
    (function (TerapyDB) {
        var CustomerTurnDialog = /** @class */ (function (_super) {
...
(function (Terapy) {
    var TerapyDB;
    (function (TerapyDB) {
        var CustomerTurnGrid = /** @class */ (function (_super) {
...
(function (Terapy) {
    var TerapyDB;
    (function (TerapyDB) {
        var CustomerListFormatter = /** @class */ (function () {
            function CustomerListFormatter() {
            }
            CustomerListFormatter.prototype.format = function (ctx) {
                var idList = ctx.value;
                if (!idList || !idList.length)
                    return "";
                var byId = TerapyDB.CustomersRow.getLookup().itemById;
                return idList.map(function (x) {
                    var g = byId[x];
                    if (!g)
                        return x.toString();
                    return Q.htmlEncode(g.CustomerName + ' ' + g.CustomerSurname);
                }).join(", ");
            };
            CustomerListFormatter = __decorate([
                Serenity.Decorators.registerFormatter()
            ], CustomerListFormatter);
            return CustomerListFormatter;
        }());
        TerapyDB.CustomerListFormatter = CustomerListFormatter;
    })(TerapyDB = Terapy.TerapyDB || (Terapy.TerapyDB = {}));
})(Terapy || (Terapy = {}));
var Terapy;
(function (Terapy) {
    ...
    (function (TerapyDB) {
        var CustomersDialog = /** @class */ (function (_super) {
            ...
            function CustomersDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new TerapyDB.CustomersForm(_this.idPrefix);
                return _this;
            }
            CustomersDialog.prototype.getFormKey = function () { return TerapyDB.CustomersForm.formKey; };
            CustomersDialog.prototype.getIdProperty = function () { return TerapyDB.CustomersRow.idProperty; };
            CustomersDialog.prototype.getLocalTextPrefix = function () { return TerapyDB.CustomersRow.localTextPrefix; };
            CustomersDialog.prototype.getNameProperty = function () { return TerapyDB.CustomersRow.nameProperty; };
            CustomersDialog.prototype.getService = function () { return TerapyDB.CustomersService.baseUrl; };
        ...
        TerapyDB.CustomersDialog = CustomersDialog;
    })(TerapyDB = Terapy.TerapyDB || (Terapy.TerapyDB = {}));
})(Terapy || (Terapy = {}));
var Terapy;
(function (Terapy) {
    ...
    (function (TerapyDB) {
        var CustomersGrid = /** @class */ (function (_super) {
            ...
            CustomersGrid.prototype.getColumnsKey = function () { return 'TerapyDB.Customers'; };
            CustomersGrid.prototype.getDialogType = function () { return TerapyDB.CustomersDialog; };
            CustomersGrid.prototype.getIdProperty = function () { return TerapyDB.CustomersRow.idProperty; };
            CustomersGrid.prototype.getLocalTextPrefix = function () { return TerapyDB.CustomersRow.localTextPrefix; };
            CustomersGrid.prototype.getService = function () { return TerapyDB.CustomersService.baseUrl; };
            CustomersGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], CustomersGrid);
            return CustomersGrid;
        }(Serenity.EntityGrid));
        TerapyDB.CustomersGrid = CustomersGrid;
    })(TerapyDB = Terapy.TerapyDB || (Terapy.TerapyDB = {}));
})(Terapy || (Terapy = {}));
var Terapy;
(function (Terapy) {
    var TerapyDB;
    (function (TerapyDB) {
        var TerapyListFormatter = /** @class */ (function () {
            function TerapyListFormatter() {
            }
            TerapyListFormatter.prototype.format = function (ctx) {
                var idList = ctx.value;
                if (!idList || !idList.length)
                    return "";
                var byId = TerapyDB.TerapyTypeRow.getLookup().itemById;
                return idList.map(function (x) {
                    var g = byId[x];
                    if (!g)
                        return x.toString();
            ...
            TerapyListFormatter = __decorate([
                Serenity.Decorators.registerFormatter()
            ], TerapyListFormatter);
            return TerapyListFormatter;
        }());
        TerapyDB.TerapyListFormatter = TerapyListFormatter;
    })(TerapyDB = Terapy.TerapyDB || (Terapy.TerapyDB = {}));
})(Terapy || (Terapy = {}));
var Terapy;
(function (Terapy) {
    var TerapyDB;
    (function (TerapyDB) {
        var TurnTerapyListFormatter = /** @class */ (function () {
            function TurnTerapyListFormatter() {
            }
            TurnTerapyListFormatter.prototype.format = function (ctx) {
                var idList = ctx.value;
                if (!idList || !idList.length)
                    return "";
            ...
            TurnTerapyListFormatter = __decorate([
                Serenity.Decorators.registerFormatter()
            ], TurnTerapyListFormatter);
            return TurnTerapyListFormatter;
        }());
        TerapyDB.TurnTerapyListFormatter = TurnTerapyListFormatter;
    })(TerapyDB = Terapy.TerapyDB || (Terapy.TerapyDB = {}));
})(Terapy || (Terapy = {}));
var Terapy;
(function (Terapy) {
    var TerapyDB;
    (function (TerapyDB) {
        var CategoriesTerapyDialog = /** @class */ (function (_super) {
            __extends(CategoriesTerapyDialog, _super);
            function CategoriesTerapyDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new TerapyDB.CategoriesTerapyForm(_this.idPrefix);
                return _this;
            }
            CategoriesTerapyDialog.prototype.getFormKey = function () { return TerapyDB.CategoriesTerapyForm.formKey; };
            CategoriesTerapyDialog.prototype.getIdProperty = function () { return TerapyDB.CategoriesTerapyRow.idProperty; };
            CategoriesTerapyDialog.prototype.getLocalTextPrefix = function () { return TerapyDB.CategoriesTerapyRow.localTextPrefix; };
            CategoriesTerapyDialog.prototype.getNameProperty = function () { return TerapyDB.CategoriesTerapyRow.nameProperty; };
            CategoriesTerapyDialog.prototype.getService = function () { return TerapyDB.CategoriesTerapyService.baseUrl; };
            CategoriesTerapyDialog = __decorate([
                Serenity.Decorators.registerClass(),
                Serenity.Decorators.responsive()
            ], CategoriesTerapyDialog);
            return CategoriesTerapyDialog;
        }(Serenity.EntityDialog));
        TerapyDB.CategoriesTerapyDialog = CategoriesTerapyDialog;
    })(TerapyDB = Terapy.TerapyDB || (Terapy.TerapyDB = {}));
})(Terapy || (Terapy = {}));
var Terapy;
(function (Terapy) {
    var TerapyDB;
    (function (TerapyDB) {
        var CategoriesTerapyGrid = /** @class */ (function (_super) {
            __extends(CategoriesTerapyGrid, _super);
            function CategoriesTerapyGrid(container) {
                return _super.call(this, container) || this;
            }
            CategoriesTerapyGrid.prototype.getColumnsKey = function () { return 'TerapyDB.CategoriesTerapy'; };
            CategoriesTerapyGrid.prototype.getDialogType = function () { return TerapyDB.CategoriesTerapyDialog; };
            CategoriesTerapyGrid.prototype.getIdProperty = function () { return TerapyDB.CategoriesTerapyRow.idProperty; };
            CategoriesTerapyGrid.prototype.getLocalTextPrefix = function () { return TerapyDB.CategoriesTerapyRow.localTextPrefix; };
            CategoriesTerapyGrid.prototype.getService = function () { return TerapyDB.CategoriesTerapyService.baseUrl; };
            CategoriesTerapyGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], CategoriesTerapyGrid);
            return CategoriesTerapyGrid;
        }(Serenity.EntityGrid));
        TerapyDB.CategoriesTerapyGrid = CategoriesTerapyGrid;
    })(TerapyDB = Terapy.TerapyDB || (Terapy.TerapyDB = {}));
})(Terapy || (Terapy = {}));
var Terapy;
(function (Terapy) {
    ...
    })(Organization = Terapy.Organization || (Terapy.Organization = {}));
})(Terapy || (Terapy = {}));
var Terapy;
(function (Terapy) {
    var Organization;
...
(function (Terapy) {
    ...
    (function (Northwind) {
        var TerritoryDialog = /** @class */ (function (_super) {
            ...
            TerritoryDialog.prototype.getLanguages = function () {
                return Terapy.LanguageList.getValue();
            };
    ...
    })(Northwind = Terapy.Northwind || (Terapy.Northwind = {}));
})(Terapy || (Terapy = {}));
var Terapy;
(function (Terapy) {
    var Northwind;
    ...
    (function (Northwind) {
        var ProductGrid = /** @class */ (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                ...
                buttons.push(Terapy.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    service: Northwind.ProductService.baseUrl + '/ListExcel',
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    separator: true
                }));
                buttons.push(Terapy.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
...
(function (Terapy) {
    ...
    })(Common = Terapy.Common || (Terapy.Common = {}));
})(Terapy || (Terapy = {}));
...
(function (Terapy) {
    ...
    (function (Northwind) {
        ...
        }(Terapy.Common.GridEditorDialog));
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        Terapy.Common.ReportHelper.execute({
                            reportKey: 'Northwind.OrderDetail',
                            params: {
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: Terapy.Authorization.userDefinition.DisplayName,
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                Terapy.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
...
(function (Terapy) {
    ...
    })(Membership = Terapy.Membership || (Terapy.Membership = {}));
})(Terapy || (Terapy = {}));
var Terapy;
(function (Terapy) {
    var Membership;
...
(function (Terapy) {
    ...
    })(Meeting = Terapy.Meeting || (Terapy.Meeting = {}));
})(Terapy || (Terapy = {}));
var Terapy;
(function (Terapy) {
    var Meeting;
        ...
        var MeetingAttendeeEditor = /** @class */ (function (_super) {
            ...
            MeetingAttendeeEditor.prototype.createToolbarExtensions = function () {
                ...
                Serenity.Widget.create({
                    type: Serenity.LookupEditor,
                    options: {
                        lookupKey: Terapy.Organization.ContactRow.lookupKey
                    },
                    ...
                    init: function (w) { return w.changeSelect2(function (x) {
                        if (Q.isEmptyOrNull(w.value))
                            return;
                        var contact = Terapy.Organization.ContactRow.getLookup().itemById[Q.toId(w.value)];
                        w.value = null;
                        if (!contact)
                            return;
...
(function (Terapy) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = Terapy.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = Terapy.LanguageList || (Terapy.LanguageList = {}));
})(Terapy || (Terapy = {}));
...
(function (Terapy) {
    ...
    (function (ScriptInitialization) {
        ...
        Serenity.EntityDialog.defaultLanguageList = Terapy.LanguageList.getValue;
    })(ScriptInitialization = Terapy.ScriptInitialization || (Terapy.ScriptInitialization = {}));
})(Terapy || (Terapy = {}));
var Terapy;
(function (Terapy) {
    var Common;
...
(function (Terapy) {
    ...
    Terapy.BasicProgressDialog = BasicProgressDialog;
})(Terapy || (Terapy = {}));
var Terapy;
(function (Terapy) {
    var Common;
    (function (Common) {
        var BulkServiceAction = /** @class */ (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new Terapy.BasicProgressDialog();
...
(function (Terapy) {
    ...
    })(DialogUtils = Terapy.DialogUtils || (Terapy.DialogUtils = {}));
})(Terapy || (Terapy = {}));
var Terapy;
(function (Terapy) {
    var Common;
...
(function (Terapy) {
    ...
    (function (BasicSamples) {
        ...
        }(Terapy.Northwind.OrderGrid));
        BasicSamples.WrappedHeadersGrid = WrappedHeadersGrid;
    })(BasicSamples = Terapy.BasicSamples || (Terapy.BasicSamples = {}));
})(Terapy || (Terapy = {}));
var Terapy;
(function (Terapy) {
    var BasicSamples;
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return Terapy.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return Terapy.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return Terapy.Northwind.SalesByCategoryService.baseUrl; };
            /**
        ...
        var TreeGrid = /** @class */ (function (_super) {
            ...
            function TreeGrid(container) {
                ...
                _this.treeMixin = new Serenity.TreeGridMixin({
                    ...
                    toggleField: Terapy.Northwind.OrderRow.Fields.CustomerCompanyName,
...
(function (Terapy) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return Terapy.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return Terapy.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (Terapy) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return Terapy.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return Terapy.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return Terapy.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return Terapy.Northwind.OrderService.baseUrl; };
            /**
            ...
            QuickFilterCustomization.prototype.getQuickFilters = function () {
                ...
                var fld = Terapy.Northwind.OrderRow.Fields;
...
(function (Terapy) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return Terapy.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return Terapy.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return Terapy.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return Terapy.Northwind.ProductService.baseUrl; };
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            Terapy.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
                        ...
                        var dlg = new Terapy.Northwind.OrderDialog();
                        this.initDialog(dlg);
                        dlg.loadEntityAndOpenDialog({
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == fld.ShippingState; }).init = function (w) {
                    ...
                    w.value = Terapy.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
...
(function (Terapy) {
    ...
    Terapy.SelectableEntityGrid = SelectableEntityGrid;
})(Terapy || (Terapy = {}));
...
(function (Terapy) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return Terapy.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return Terapy.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return Terapy.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return Terapy.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(Terapy.SelectableEntityGrid));
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(Terapy.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new Terapy.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new Terapy.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new Terapy.Northwind.OrderDialog().loadEntityAndOpenDialog({
                        CustomerID: item.CustomerID,
                    ...
                    var countryFilter = this.findQuickFilter(Serenity.LookupEditor, Terapy.Northwind.OrderRow.Fields.ShipCountry);
...
(function (Terapy) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return Terapy.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return Terapy.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return Terapy.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return Terapy.Northwind.ProductService.baseUrl; };
            /**
            ...
            ConditionalFormattingGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = Terapy.Northwind.ProductRow.Fields;
...
(function (Terapy) {
    ...
    (function (BasicSamples) {
        ...
        }(Terapy.Common.BulkServiceAction));
...
(function (Terapy) {
    ...
    Terapy.StaticTextBlock = StaticTextBlock;
})(Terapy || (Terapy = {}));
var Terapy;
(function (Terapy) {
    var BasicSamples;
...
(function (Terapy) {
    ...
    (function (BasicSamples) {
        ...
        }(Terapy.Northwind.ProductDialog));
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return Terapy.Northwind.CategoryRow.lookupKey;
            };
            /**
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new Terapy.Northwind.OrderDetailForm(_this.idPrefix);
                ...
                _this.form.ProductID.cascadeField = Terapy.Northwind.ProductRow.Fields.CategoryID;
                return _this;
        ...
        }(Terapy.Northwind.OrderDetailDialog));
...
(function (Terapy) {
    ...
    (function (BasicSamples) {
        ...
        }(Terapy.Northwind.OrderDetailsEditor));
...
(function (Terapy) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return Terapy.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return Terapy.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return Terapy.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return Terapy.Northwind.OrderService.baseUrl; };
        ...
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    var productID = Q.toId(_this.form.ProductID.value);
                    if (productID != null) {
                        _this.form.UnitPrice.value = Terapy.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
                _this.form.Discount.addValidationRule(_this.uniqueName, function (e) {
                    var price = _this.form.UnitPrice.value;
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return Terapy.Northwind.OrderDetailRow.localTextPrefix; };
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return Terapy.Northwind.ProductRow.lookupKey;
            };
...
(function (Terapy) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    Terapy.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(Terapy.Northwind.CustomerDialog));
...
(function (Terapy) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = /** @class */ (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return Terapy.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return Terapy.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return Terapy.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return Terapy.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return Terapy.Northwind.OrderService.baseUrl; };
...
(function (Terapy) {
    ...
    (function (BasicSamples) {
        ...
        }(Terapy.Northwind.SupplierDialog));
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(Terapy.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    Terapy.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return Terapy.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return Terapy.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return Terapy.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return Terapy.Northwind.OrderService.baseUrl; };
        ...
        var OtherFormOneBarDialog = /** @class */ (function (_super) {
            ...
            function OtherFormOneBarDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    items: Q.getForm(Terapy.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new Terapy.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
            ...
            OtherFormOneBarDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(Terapy.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
            ...
            OtherFormOneBarDialog.prototype.saveCustomer = function (callback, onSuccess) {
                ...
                if (!id) {
                    ...
                    Terapy.Northwind.CustomerService.Update({
                        EntityId: id,
                        Entity: c
                    }, function (response) {
                        // reload customer list just in case
                        Q.reloadLookup(Terapy.Northwind.CustomerRow.lookupKey);
...
(function (Terapy) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    Terapy.Northwind.CategoryService.Retrieve({
        ...
        }(Terapy.Northwind.CategoryDialog));
        ...
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: Terapy.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: Terapy.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var chai = Terapy.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = Terapy.Northwind.EmployeeRow.getLookup().items
...
(function (Terapy) {
    ...
    })(Administration = Terapy.Administration || (Terapy.Administration = {}));
})(Terapy || (Terapy = {}));
var Terapy;
(function (Terapy) {
    var Administration;
...
(function (Terapy) {
    ...
    })(Authorization = Terapy.Authorization || (Terapy.Authorization = {}));
})(Terapy || (Terapy = {}));
var Terapy;
(function (Terapy) {
    var Administration;
...
(function (Terapy) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return Terapy.Northwind.CustomerEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['CategoryID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return BasicSamples.FilteredLookupDetailEditor; }]].forEach(function (x) { return Object.defineProperty(FilteredLookupInDetailForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = Terapy.BasicSamples || (Terapy.BasicSamples = {}));
})(Terapy || (Terapy = {}));
var Terapy;
(function (Terapy) {
...
(function (Terapy) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return Terapy.Northwind.CustomerEditor; }], ['CustomerContactName', function () { return Serenity.StringEditor; }], ['CustomerContactTitle', function () { return Serenity.StringEditor; }], ['CustomerCity', function () { return Serenity.StringEditor; }], ['CustomerRegion', function () { return Serenity.StringEditor; }], ['CustomerCountry', function () { return Serenity.StringEditor; }], ['CustomerPhone', function () { return Serenity.StringEditor; }], ['CustomerFax', function () { return Serenity.StringEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['RequiredDate', function () { return Serenity.DateEditor; }], ['EmployeeID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return Terapy.Northwind.OrderDetailsEditor; }]].forEach(function (x) { return Object.defineProperty(PopulateLinkedDataForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = Terapy.BasicSamples || (Terapy.BasicSamples = {}));
})(Terapy || (Terapy = {}));
var Terapy;
(function (Terapy) {
...
(function (Terapy) {
    ...
    (function (BasicSamples) {
        ...
        [['StaticText', function () { return Terapy.StaticTextBlock; }], ['SomeInput', function () { return Serenity.StringEditor; }], ['HtmlList', function () { return Terapy.StaticTextBlock; }], ['FromLocalText', function () { return Terapy.StaticTextBlock; }], ['DisplayFieldValue', function () { return Terapy.StaticTextBlock; }]].forEach(function (x) { return Object.defineProperty(StaticTextBlockForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = Terapy.BasicSamples || (Terapy.BasicSamples = {}));
})(Terapy || (Terapy = {}));
var Terapy;
(function (Terapy) {
...
(function (Terapy) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnum(Gender, 'Terapy.Northwind.Entities.Gender');
    })(Northwind = Terapy.Northwind || (Terapy.Northwind = {}));
})(Terapy || (Terapy = {}));
var Terapy;
(function (Terapy) {
...
(function (Terapy) {
    var TerapyDB;
    (function (TerapyDB) {
        var CategoriesTerapyForm = /** @class */ (function (_super) {
            __extends(CategoriesTerapyForm, _super);
            function CategoriesTerapyForm() {
                return _super !== null && _super.apply(this, arguments) || this;
            }
            CategoriesTerapyForm.formKey = 'TerapyDB.CategoriesTerapy';
            return CategoriesTerapyForm;
        }(Serenity.PrefixedContext));
        TerapyDB.CategoriesTerapyForm = CategoriesTerapyForm;
        [['CategoryName', function () { return Serenity.StringEditor; }]].forEach(function (x) { return Object.defineProperty(CategoriesTerapyForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(TerapyDB = Terapy.TerapyDB || (Terapy.TerapyDB = {}));
})(Terapy || (Terapy = {}));
var Terapy;
(function (Terapy) {
    var TerapyDB;
    (function (TerapyDB) {
        var CategoriesTerapyRow;
        (function (CategoriesTerapyRow) {
            CategoriesTerapyRow.idProperty = 'CategoryId';
            CategoriesTerapyRow.nameProperty = 'CategoryName';
            CategoriesTerapyRow.localTextPrefix = 'TerapyDB.CategoriesTerapy';
            CategoriesTerapyRow.lookupKey = 'TerapyDb.CategoriesTerapy';
            function getLookup() {
                return Q.getLookup('TerapyDb.CategoriesTerapy');
            }
            CategoriesTerapyRow.getLookup = getLookup;
            var Fields;
            (function (Fields) {
            })(Fields = CategoriesTerapyRow.Fields || (CategoriesTerapyRow.Fields = {}));
            ['CategoryId', 'CategoryName'].forEach(function (x) { return Fields[x] = x; });
        })(CategoriesTerapyRow = TerapyDB.CategoriesTerapyRow || (TerapyDB.CategoriesTerapyRow = {}));
    })(TerapyDB = Terapy.TerapyDB || (Terapy.TerapyDB = {}));
})(Terapy || (Terapy = {}));
var Terapy;
(function (Terapy) {
    var TerapyDB;
    (function (TerapyDB) {
        var CategoriesTerapyService;
        (function (CategoriesTerapyService) {
            CategoriesTerapyService.baseUrl = 'TerapyDB/CategoriesTerapy';
            var Methods;
            (function (Methods) {
            })(Methods = CategoriesTerapyService.Methods || (CategoriesTerapyService.Methods = {}));
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                CategoriesTerapyService[x] = function (r, s, o) { return Q.serviceRequest(CategoriesTerapyService.baseUrl + '/' + x, r, s, o); };
                Methods[x] = CategoriesTerapyService.baseUrl + '/' + x;
            });
        })(CategoriesTerapyService = TerapyDB.CategoriesTerapyService || (TerapyDB.CategoriesTerapyService = {}));
    })(TerapyDB = Terapy.TerapyDB || (Terapy.TerapyDB = {}));
})(Terapy || (Terapy = {}));
var Terapy;
(function (Terapy) {
    ...
    (function (TerapyDB) {
        var CustomersForm = /** @class */ (function (_super) {
            ...
            CustomersForm.formKey = 'TerapyDB.Customers';
            return CustomersForm;
        }(Serenity.PrefixedContext));
        TerapyDB.CustomersForm = CustomersForm;
        [['CustomerName', function () { return Serenity.StringEditor; }], ['CustomerSurname', function () { return Serenity.StringEditor; }], ['UnableTerapyList', function () { return Serenity.LookupEditor; }], ['Address', function () { return Serenity.StringEditor; }], ['City', function () { return Serenity.StringEditor; }], ['Region', function () { return Serenity.StringEditor; }], ['PostalCode', function () { return Serenity.StringEditor; }], ['Country', function () { return Serenity.StringEditor; }], ['Phone', function () { return Serenity.StringEditor; }], ['Email', function () { return Serenity.StringEditor; }]].forEach(function (x) { return Object.defineProperty(CustomersForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(TerapyDB = Terapy.TerapyDB || (Terapy.TerapyDB = {}));
})(Terapy || (Terapy = {}));
var Terapy;
(function (Terapy) {
    ...
    (function (TerapyDB) {
        ...
        (function (CustomersRow) {
            ...
            CustomersRow.localTextPrefix = 'TerapyDB.Customers';
            CustomersRow.lookupKey = 'TerapyDB.Customers';
            function getLookup() {
                return Q.getLookup('TerapyDB.Customers');
            }
            CustomersRow.getLookup = getLookup;
            var Fields;
            (function (Fields) {
            })(Fields = CustomersRow.Fields || (CustomersRow.Fields = {}));
            ['CustomerId', 'UnableTerapyList', 'TurnList', 'CustomerName', 'CustomerSurname', 'Address', 'City', 'Region', 'PostalCode', 'Country', 'Phone', 'Email'].forEach(function (x) { return Fields[x] = x; });
        })(CustomersRow = TerapyDB.CustomersRow || (TerapyDB.CustomersRow = {}));
    })(TerapyDB = Terapy.TerapyDB || (Terapy.TerapyDB = {}));
})(Terapy || (Terapy = {}));
var Terapy;
(function (Terapy) {
    ...
    (function (TerapyDB) {
        ...
        (function (CustomersService) {
            CustomersService.baseUrl = 'TerapyDB/Customers';
            var Methods;
            (function (Methods) {
            })(Methods = CustomersService.Methods || (CustomersService.Methods = {}));
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                CustomersService[x] = function (r, s, o) { return Q.serviceRequest(CustomersService.baseUrl + '/' + x, r, s, o); };
                Methods[x] = CustomersService.baseUrl + '/' + x;
            });
        })(CustomersService = TerapyDB.CustomersService || (TerapyDB.CustomersService = {}));
    })(TerapyDB = Terapy.TerapyDB || (Terapy.TerapyDB = {}));
})(Terapy || (Terapy = {}));
var Terapy;
(function (Terapy) {
    var TerapyDB;
    (function (TerapyDB) {
        var CustomerTurnForm = /** @class */ (function (_super) {
...
(function (Terapy) {
    ...
    (function (TerapyDB) {
        ...
        (function (EmployeesRow) {
            ...
            EmployeesRow.lookupKey = 'TerapyDb.Employees';
            function getLookup() {
                return Q.getLookup('TerapyDb.Employees');
            }
...
(function (Terapy) {
    var TerapyDB;
    (function (TerapyDB) {
        var MessagesTranslationForm = /** @class */ (function (_super) {
...
(function (Terapy) {
    var TerapyDB;
    (function (TerapyDB) {
        var SchedulerTerapyForm = /** @class */ (function (_super) {
...
(function (Terapy) {
    var TerapyDB;
    (function (TerapyDB) {
        var TerapyTypeForm = /** @class */ (function (_super) {
...
(function (Terapy) {
    ...
    (function (TerapyDB) {
        ...
        (function (TerapyTypeRow) {
            ...
            TerapyTypeRow.lookupKey = 'TerapyDB.TerapyType';
            function getLookup() {
                return Q.getLookup('TerapyDB.TerapyType');
            }
            TerapyTypeRow.getLookup = getLookup;
            var Fields;
            (function (Fields) {
...
(function (Terapy) {
    var TerapyDB;
    (function (TerapyDB) {
        var TurnTerapyForm = /** @class */ (function (_super) {
            __extends(TurnTerapyForm, _super);
            function TurnTerapyForm() {
                return _super !== null && _super.apply(this, arguments) || this;
            }
            TurnTerapyForm.formKey = 'TerapyDB.TurnTerapy';
...
(function (Terapy) {
    var TerapyDB;
    (function (TerapyDB) {
        var TurnTerapyService;
        (function (TurnTerapyService) {
            TurnTerapyService.baseUrl = 'TerapyDB/TurnTerapy';
            var Methods;
            (function (Methods) {
            })(Methods = TurnTerapyService.Methods || (TurnTerapyService.Methods = {}));
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                TurnTerapyService[x] = function (r, s, o) { return Q.serviceRequest(TurnTerapyService.baseUrl + '/' + x, r, s, o); };
...
(function (Terapy) {
    var TerapyDB;
    (function (TerapyDB) {
        var UnableTerapyCustomerForm = /** @class */ (function (_super) {
